---
name: wait-what
description: "Re-pitch the previous explanation with missing context and simpler language. Use only when the user explicitly invokes wait-what or says the explanation did not land."
---
